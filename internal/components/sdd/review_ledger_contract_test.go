...
func TestKilocodeReviewSettingsMatchCurrentMainBaseline(t *testing.T) {
	...
	// #4090 changed the shared native untracked settlement recovery instructions,
	// deliberately moving this embedded rendered settings hash.
	const want = "265cbaf5f1fd60a9dbe021838cba8f3e3aa181f1cf006ca796a18547e2254d71"
	if got != want {
