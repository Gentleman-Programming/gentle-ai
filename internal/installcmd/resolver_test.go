...
func TestResolveComponentInstall(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:      CommandSequence{{"brew", "trust", "--formula", "gentleman-programming/tap/engram"}, {"brew", "tap", "Gentleman-Programming/homebrew-tap"}, {"brew", "install", "engram"}},
		},
		...
		},
		{
			...
			want:      CommandSequence{{"brew", "trust", "--formula", "gentleman-programming/tap/gga"}, {"brew", "tap", "Gentleman-Programming/homebrew-tap"}, {"brew", "reinstall", "gga"}},
		},
		{
