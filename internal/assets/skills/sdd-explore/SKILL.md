...
2. **Level 1 (only if missing)**: Load the `qa-locator-hunting` skill and follow it — it owns domain→project resolution, the GitLab hunt via MCP, and the selector priority rules.
