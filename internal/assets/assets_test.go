...
func TestSDDOrchestratorsParallelApplySchedulingPolicyParity(t *testing.T) {
	...
	if !strings.Contains(commonContent, "## G. Parallel Apply Scheduling Policy") {
		t.Fatalf("skills/_shared/sdd-phase-common.md missing section header")
	}
	for _, req := range requiredClauses[1:] {
