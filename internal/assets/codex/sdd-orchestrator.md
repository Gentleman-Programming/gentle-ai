...
When review-derived or verification-derived findings require `sdd-apply` remediation, launch a fresh provider executor/model context through the Codex phase prompt. Omit the prior provider `task_id` by default.
