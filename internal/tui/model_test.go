...
func TestWelcomeMenu_OptionCount(t *testing.T) {
	...
	opts := screens.WelcomeOptions(m.UpdateResults, m.UpdateCheckDone, false, 0, true, false, 0)
	if len(opts) != 10 {
	...
	optsWithProfiles := screens.WelcomeOptions(m.UpdateResults, m.UpdateCheckDone, true, 0, true, false, 0)
