...
// 6 items: Claude, OpenCode, Kiro, Codex, VS Code Copilot, and Back.
...
// TestModelConfigOptions_ContainsCodex verifies Codex is at index 3, VS Code at
// index 4, and Back at index 5.
func TestModelConfigOptions_ContainsCodex(t *testing.T) {
	...
	if !strings.Contains(opts[4], "VS Code Copilot") {
		t.Errorf("ModelConfigOptions()[4] = %q, want option containing 'VS Code Copilot'", opts[4])
	}
