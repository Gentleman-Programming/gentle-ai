...
func TestSkillPickerCanonicalRowsAndActions(t *testing.T) {
	...
	if view := RenderSkillPicker(skills, len(skills)+1, 7); !strings.Contains(view, styles.Cursor+"Back") || strings.Contains(view, "SDD Init") || !strings.Contains(view, "Rows 41-41 of 41") {
