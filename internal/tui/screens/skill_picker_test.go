...
func TestSkillPickerCanonicalRowsAndActions(t *testing.T) {
	...
	labels := []string{"SDD Init", "SDD Explore", "SDD Research", "SDD Propose", "SDD Spec", "SDD Design", "SDD Tasks", "SDD Apply", "SDD Verify", "SDD Archive", "SDD Onboard", "Judgment Day", "Go Testing", "Gentle AI Bench", "Skill Creator", "Skill Improver", "Branch & PR", "Issue Creation", "Skill Registry", "Chained PR", "Cognitive Doc Design", "Comment Writer", "Work Unit Commits", "RDD Defect Workflow", "Systemic Issue Triage", "Design Minimality"}
	...
	if view := RenderSkillPicker(skills, len(skills)+1, 7); !strings.Contains(view, styles.Cursor+"Back") || strings.Contains(view, "SDD Init") || !strings.Contains(view, "Rows 28-28 of 28") {
