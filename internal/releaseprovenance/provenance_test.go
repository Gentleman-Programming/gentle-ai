...
func TestBuildCanonicalPayload(t *testing.T) {
	...
	const want = `{"schema":"gentle-ai.release-provenance/v1","repository":"IGutierrezZ/axiom","tag":"v1.2.3-rc.4","source_sha":"0123456789abcdef0123456789abcdef01234567","workflow":{"name":"Release candidate","run_id":"42","run_attempt":2,"job":"publish"},"toolchain":{"goreleaser":"v2.15.2","go":"go1.25.10"},"provider_contract_semver":"1.4.0","configuration_sha256":"sha256:16e0d1afd6e96036b776ab20684da35f075c50d6f3c0fd599ddc8218ebbdfb56","artifacts":[{"name":"axiom_1.2.3-rc.4_darwin_amd64.tar.gz","kind":"binary","goos":"darwin","goarch":"amd64","cgo_enabled":"0","trimpath":true},{"name":"axiom_1.2.3-rc.4_darwin_arm64.tar.gz","kind":"binary","goos":"darwin","goarch":"arm64","cgo_enabled":"0","trimpath":true},{"name":"axiom_1.2.3-rc.4_linux_amd64.tar.gz","kind":"binary","goos":"linux","goarch":"amd64","cgo_enabled":"0","trimpath":true},{"name":"axiom_1.2.3-rc.4_linux_arm64.tar.gz","kind":"binary","goos":"linux","goarch":"arm64","cgo_enabled":"0","trimpath":true},{"name":"gentle-ai-review-provider-contract-1.4.0.tar.gz","kind":"provider-contract"}]}` + "\n"
