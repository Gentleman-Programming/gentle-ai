...
func TestRunSDDAttemptHelpContractsCoverEveryOperation(t *testing.T) {
	tests := []struct {
		...
		{"begin", []string{"cwd", "change", "expected-revision", "request-id", "work-unit", "evidence-goal", "max-attempts", "max-changed-lines", "task-id", "requirement-id", "scenario-id"}, []string{"default 2", "default 200", "1..100", "1..1000000", "provider-owned"}},
		...
		{"acquire", []string{"cwd", "change", "token", "request-id", "work-unit", "evidence-goal", "max-attempts", "max-changed-lines", "task-id", "requirement-id", "scenario-id", "remediates-evidence-revision"}, []string{"default 2", "default 200", "unmanaged remediation", "provider-owned"}},
