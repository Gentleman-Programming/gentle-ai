...
func reviewCapabilitiesStaticSurface(contracts ...string) ReviewCapabilitiesResult {
	...
	if contract == ReviewIntegrationContractV2 {
		result.Schema, result.Contract = ReviewIntegrationCapabilitiesSchemaV21, ReviewIntegrationContractV2
		result.Protocol = ReviewCapabilitiesProtocol{Major: 2, Minor: 1}
		for index, schema := range result.Schemas {
			...
			case ReviewIntegrationCapabilitiesSchema:
				result.Schemas[index] = ReviewIntegrationCapabilitiesSchemaV21
