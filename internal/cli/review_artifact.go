...
func discoverPendingRefuterClaims(ctx context.Context, repo, storeDir string, state reviewtransaction.CompactState, revision string) ([]reviewtransaction.RefuterClaim, error) {
	...
	return reviewtransaction.PendingRefuterClaims(state, input), nil
}
