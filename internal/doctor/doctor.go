...
const (
	...
	CheckControllerReachable   CheckID = "controller:reachable"
	CheckRoutingSyncRequired   CheckID = "routing:sync-required"
	CheckEnforcementState      CheckID = "enforcement:state"
)
