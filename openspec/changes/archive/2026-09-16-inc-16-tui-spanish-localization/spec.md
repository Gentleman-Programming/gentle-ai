# Especificación de Requerimientos: Localización Integral en Castellano de la TUI (INC-16)

## Resumen Ejecutivo
Esta especificación define los requerimientos de localización lingüística al castellano peninsular para la interfaz interactiva de terminal (TUI) de Axiom, así como el desacoplamiento de los avisos y comunicados remotos procedentes del upstream de Gentle AI.
...
- **ENTONCES** las etiquetas deben ser:
  - "Iniciar instalación" (en lugar de "Start installation")
  - "Actualizar herramientas" / "Actualizar herramientas (al día)" / "Actualizar herramientas ★" (en lugar de "Upgrade tools")
  - "Sincronizar configuraciones" (en lugar de "Sync configs")
  - "Actualizar y sincronizar" (en lugar de "Upgrade + Sync")
  - "Configurar modelos" (en lugar de "Configure models")
  - "Crear agente personalizado" (en lugar de "Create your own Agent")
  - "Plugins comunitarios de OpenCode" (en lugar de "OpenCode Community Plugins")
  - "Desinstalar plugin de OpenCode" (en lugar de "Uninstall OpenCode Plugin")
  - "Perfiles SDD de OpenCode" (en lugar de "OpenCode SDD Profiles")
  - "Gestionar respaldos" (en lugar de "Manage backups")
  - "Reiniciar almacén de revisiones" (en lugar de "Reset review store")
  - "Revisión formal RDD" (en lugar de "Receipt-Driven Development")
  - "Desinstalación gestionada" (en lugar de "Managed uninstall")
  - "Herramientas y plugins comunitarios" (en lugar de "Community Tools/Plugins")
  - "Salir" (en lugar de "Quit")
...
- **ENTONCES** la cabecera de la lista debe mostrar "Menú" (en lugar de "Menu")
- **Y** la barra inferior de ayuda debe mostrar `j/k: navegar • enter: seleccionar • q: salir` (en lugar de `j/k: navigate • enter: select • q: quit`).
