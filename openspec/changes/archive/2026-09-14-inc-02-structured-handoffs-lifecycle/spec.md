# Especificación de Requerimientos: Handoffs Estructurados y Ciclo de Vida de Transición (INC-02)

## Propósito

Definir de forma rigurosa, ejecutable y verificable los requerimientos funcionales y escenarios BDD para el artefacto canónico `handoff.md`, el paquete de dominio `internal/handoff`, los subcomandos de la CLI `axiom handoff` y la integración universal de las compuertas de relevo (*Gate-In* y *Gate-Out*) en las skills canónicas y orquestadores de Axiom para todos los adaptadores soportados.
...
- **CUANDO** se llama a `ToEngramObservation(h)`
