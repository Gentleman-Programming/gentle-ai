# Especificación Viva: Topología de Workspace y CLI de Axiom
...
El binario ejecutable `axiom` proporciona la interfaz unificada de línea de comandos para la plataforma.
