...
|---|---|---|---|---|---|
| [#1644](https://github.com/Gentleman-Programming/gentle-ai/issues/1644) | Local-design-flaw: attribute timeout to initialize versus `tools/list` in `internal/components/communitytool/pi_codegraph.go`. | Focused timeout regression reproduced the defect 10/10. | `executed and reproduced` | Open; `approved` | No active related PR found; no design prerequisite recorded. |
...
| Evidence language | A proposed oracle is not described as executed. Only #1644 is recorded as reproduced; #1883 and #1937 record focused-suite evidence while retaining an exact-regression gap. |
