...
- Generic recovery never replaces acknowledged approved authority. Escalated review remains receiptless and may recover only through the existing scope/state predicates and a distinct successor lineage.
