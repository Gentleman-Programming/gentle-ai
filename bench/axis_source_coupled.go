...
func init() {
	RegisterAxis(Axis{
		...
		Properties: []string{
			...
			"The portable black-box core excludes j57 and contains 101 journeys. Select this axis explicitly and build the product with `-tags bench_fixture` to run the proof.",
