...
var coreJourneyReviewModes = map[string]ReviewPrecondition{
	...
	// #3708: the final-verification applicability decision is SDD-owned, so
	// neither journey may depend on whether review is enabled.
	"j119-passive-candidate-does-not-owe-final-verification":                    reviewUntouched,
	"j120-active-candidate-still-owes-final-verification":                       reviewUntouched,
