...
func sddPostReviewVerifyReportJourneys() []Journey {
	return []Journey{{
		...
		Title:  "#3867: native final-verify settlement preserves its report attestation while archive remains unmanaged ordinary policy",
		Source: "native SDD report-attestation contract under #3867: retained review approval is not selected as an SDD archive gate",
		Steps: append(sddAcknowledgedAuthoritySteps(sddSharedScaffoldingAuthorityFixture),
			Step{Name: "retained approval leaves initial archive readiness under unmanaged ordinary policy", Requires: sddStatusCapability,
		...
		Review: reviewOptedIn,
		Title:  "#3867: legacy final-verify settlement preserves its compatibility record without creating an SDD archive gate",
		Source: "native SDD report-attestation compatibility under #3867: retained review approval leaves legacy and current settlement metadata under unmanaged archive policy",
		Steps: append(sddAcknowledgedAuthoritySteps(sddSharedScaffoldingAuthorityFixture),
			Step{Name: "final verification replaces and stages only the canonical report", Fixture: sddReplacePostReviewVerifyReport},
